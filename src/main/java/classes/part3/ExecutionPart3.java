...
public class ExecutionPart3 {
    public static void main(String[] args) {
        ...
        entityManager.persist(new Aluno("João", 22, estadoParaAdicionar));
        ...
        //consulta que retorna o mesmo valor equivalente aos seguintes SQL;
        // SELECT * FROM Aluno WHERE id = 1 (Equivalente ao método find do entitymanager na parte 2.2)
        // SELECT * FROM Aluno WHERE nome = 'Daniel' (Sera o quivalente para as outras consultas nas partes 2.3 - 2.4 - 2.5)

        // 2.1 - O parametro de busca que sera utilizado nas proximas consultas
        String nome = "Daniel";
...
//        // não é possivel!!! Deve utilizar um dos métodos utilizados a baixo nas partes 2.3 - 2.4 - 2.5
//
...
//        alunoSQLList.forEach(Aluno -> System.out.println("Consulta alunoSQLList: " + Aluno));
        ...
        // Trazendo uma lista como resultado
//        String jpqlList = "select a from Aluno a where a.estado.nome = :estadoNome"; // op1
//        String jpqlList = "select a from Aluno a where a.estado.nome = :estadoId"; // op2
        String jpqlList = "select a from Aluno a where a.estado = :estado"; // op3
        List<Aluno> alunoJPQLList = entityManager
                .createQuery(jpqlList, Aluno.class)
//                .setParameter("estadoNome", "Rio de Janeiro") //op1
//                .setParameter("estadoId", 1) //op2
//                .setParameter("estado", entityManager.find(Estado.class, 1)) //op3
                .setParameter("estado", estadoParaAdicionar)//op3
                .getResultList();

        // Resultado das consultas acima
        System.out.println("Consulta do alunoJPQL: " + alunoJPQL);
...
//
//        // Trazendo uma listomo resultado
